...
- `LICENSE` (ours, MIT) and a `NOTICE` carrying the upstream MIT text and copyright line
  (C-009). Both need a copyright holder decided; no reference code has been ported yet.
