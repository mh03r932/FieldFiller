...
| UC-027 | Migrate Settings from Fake Filler | Migrating User | Convert a Fake Filler backup into our schema and report the result | FR-055, FR-056, FR-073 | High | **Drafted 2026-08-24** — against the reference's published schema as recorded in `FAKEFILLER_RESEARCH.md` (BR-027-2); discharges UC-026 A5's owed pointer. Unbuilt |
